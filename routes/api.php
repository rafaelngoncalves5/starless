        ...
        [
            ...
            "Endpoints" => [
                ...
                "Posts" => [
                    ...
                    "/posts/like/{id}" => "Likes a posts by id. Accepts `POST` and `GET`. Receives an `id[int]` query param and a `bearer token`.",
                    "/posts/upload/{id}" => "Uploads an image to a post. Accepts `POST`. an `id[int]` query param, a `bearer token` and an `file[image]`.",
                ],
